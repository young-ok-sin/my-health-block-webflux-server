...
public class EasyCodefConstant {
    ...
    /**	샌드박스 엑세스 토큰 발급을 위한 클라이언트 아이디	*/
    protected static final String DEMO_CLIENT_ID 	= "ef27cfaa-10c1-4470-adac-60ba476273f9";

    /**	샌드박스 엑세스 토큰 발급을 위한 클라이언트 시크릿	*/
    protected static final String DEMO_CLIENT_SECRET 	= "83160c33-9045-4915-86d8-809473cdf5c3";
